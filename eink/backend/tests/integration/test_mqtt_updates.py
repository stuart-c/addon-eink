...
async def test_mqtt_independent_item_selection(aiohttp_client, app):
    ...
    async with database.get_session() as session:
        ...
        slices = [
            models.SceneDisplayImage(scene_id="test-scene", display_id="d1", image_id="img1", filename="slice1_img1.png", scene_hash="hash1", image_hash="h1"),
            models.SceneDisplayImage(scene_id="test-scene", display_id="d1", image_id="img2", filename="slice1_img2.png", scene_hash="hash1", image_hash="h2"),
            models.SceneDisplayImage(scene_id="test-scene", display_id="d2", image_id="img1", filename="slice2_img1.png", scene_hash="hash1", image_hash="h1"),
            models.SceneDisplayImage(scene_id="test-scene", display_id="d2", image_id="img2", filename="slice2_img2.png", scene_hash="hash1", image_hash="h2"),
        ]
        for s in slices:
            session.add(s)
...
async def test_mqtt_same_item_selection(aiohttp_client, app):
    ...
    async with database.get_session() as session:
        ...
        # Add slices
        slices = [
            models.SceneDisplayImage(scene_id="multi-display-scene", display_id="d1", image_id="img1", filename="d1_img1.png", scene_hash="hash2", image_hash="h1"),
            models.SceneDisplayImage(scene_id="multi-display-scene", display_id="d1", image_id="img2", filename="d1_img2.png", scene_hash="hash2", image_hash="h2"),
            models.SceneDisplayImage(scene_id="multi-display-scene", display_id="d2", image_id="img1", filename="d2_img1.png", scene_hash="hash2", image_hash="h1"),
            models.SceneDisplayImage(scene_id="multi-display-scene", display_id="d2", image_id="img2", filename="d2_img2.png", scene_hash="hash2", image_hash="h2"),
        ]
        for s in slices:
            session.add(s)
        await session.commit()
    ...
    with patch("random.choice") as mock_choice:
        ...
        await manager._handle_layout_update("multi-display-layout", scene_name="Multi Display Scene")
